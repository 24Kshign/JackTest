 ...
 */
public class PullUpLoadingRecyclerView extends DropDownRefreshRecyclerView {
    ...
    // 默认状态
    public static final int LOAD_STATUS_NORMAL = 1;
    // 上拉加载更多状态
    public static final int LOAD_STATUS_PULL_DOWN_REFRESH = 2;
    // 松开加载更多状态
    public static final int LOAD_STATUS_LOOSEN_LOADING = 3;
    // 正在加载更多状态
    public static final int LOAD_STATUS_LOADING = 4;

    private boolean isHaveData;

    public PullUpLoadingRecyclerView(Context context) {
        super(context);
    }

    public PullUpLoadingRecyclerView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public PullUpLoadingRecyclerView(Context context, @Nullable AttributeSet attrs, int defStyle) {
    ...
    private void restoreLoadView() {
        ...
        // 回弹到指定位置
        ValueAnimator animator = ObjectAnimator.ofFloat(currentBottomMargin, 0).setDuration(currentBottomMargin);
