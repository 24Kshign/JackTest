...
import cn.share.jack.module2.recyclerview.wrap.WrapRecyclerView;

/**
 * Created by jack on 2018/6/8
 */
public class DropDownRefreshRecyclerView extends WrapRecyclerView {
    ...
    public DropDownRefreshRecyclerView(Context context) {
        super(context);
    }

    public DropDownRefreshRecyclerView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public DropDownRefreshRecyclerView(Context context, @Nullable AttributeSet attrs, int defStyle) {
    ...
    private void addRefreshView() {
        ...
        if (adapter != null) {
            if (null == mRefreshCreator) {
                mRefreshCreator = new DefaultRefreshView();
            }
            // 添加头部的刷新View
