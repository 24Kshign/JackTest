package cn.share.jack.module2.titlebar;
...
class FRTitleBarController {
    ...
    private void createAndBindView() {
        ...
        if (mParams.mParent instanceof RelativeLayout && mParams.mParent.getChildCount() > 1) {
            View firstView = mParams.mParent.getChildAt(1);
            RelativeLayout.LayoutParams params = (RelativeLayout.LayoutParams) firstView.getLayoutParams();
            params.addRule(RelativeLayout.BELOW, mNavigationView.getId());
        ...
        public void apply(FRTitleBarController controller) {
            ...
            if (null != viewHelper) {
                ...
                if (null != mRightOnClickListener) {
                    controller.setOnClickListener(!TextUtils.isEmpty(mRightIcon) ? R.id.lt_iv_right : R.id.lt_tv_titlebar_right, mRightOnClickListener);
                }
            }
        }
    }
